...
from retriever.custom_bm25_retriever import BM25Retriever
from retriever.custom_faiss_retriever import FaissRetriever
...
#     config = {
#             "embedding_model_path": "dragonkue/BGE-m3-ko",
#             "tokenizer_path":"/data/models/Qwen2.5-32B-Instruct",
#             "faiss_path": "/data/jj/salt/data/salt_dbs/text_512_table_4096", 
#             "jsonl_path": "/data/jj/salt/data/salt_dbs/text_512_table_4096/text_512_table_4096_2.jsonl"
#     }
#     hybrid = HybridRetrieverChain(config)
#     print("==========")
#     chain = hybrid.create_retrieval_chain()
